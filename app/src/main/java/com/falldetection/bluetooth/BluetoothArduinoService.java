...
public class BluetoothArduinoService {
    private final static String TAG = BluetoothArduinoService.class.getSimpleName();

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "PhoneBluetoothSerialServiceSecure";
     ...
     */
    public BluetoothArduinoService(FragmentActivity activity, Handler handler) {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(Constants.MESSAGE_READ, data).sendToTarget();
                    ...
                    if (bytes > 0) {
                        ...
                        mHandler.obtainMessage(Constants.MESSAGE_READ_RAW, rawdata).sendToTarget();
                    }
